...
class Autozip extends Module
{
	...
	public function __construct()
	{
		...
		$this->version = '1.0.0';
		$this->author = 'Kimengumi.fr';
		$this->need_instance = 0;

		/**
		 * Set $this->bootstrap to true if your module is compliant with bootstrap (Antonio Rossetti 1.6)
		 */
		$this->bootstrap = true;
	...
	{
		Configuration::updateValue('AUTOZIP_LIVE_MODE', false);
	...
	{
		Configuration::deleteByName('AUTOZIP_LIVE_MODE');
			...
			'form' => array(
				...
				'input' => array(
					...
					array(
						...
						'name' => 'AUTOZIP_ACCOUNT_EMAIL',
						'label' => $this->l('Email'),
					),
					array(
						'type' => 'password',
						'name' => 'AUTOZIP_ACCOUNT_PASSWORD',
	...
	{
		return array(
			'AUTOZIP_LIVE_MODE' => Configuration::get('AUTOZIP_LIVE_MODE', true),
			'AUTOZIP_ACCOUNT_EMAIL' => Configuration::get('AUTOZIP_ACCOUNT_EMAIL', 'contact@prestashop.com'),
			'AUTOZIP_ACCOUNT_PASSWORD' => Configuration::get('AUTOZIP_ACCOUNT_PASSWORD', null),
		);
	}
